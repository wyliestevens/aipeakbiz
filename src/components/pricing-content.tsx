...
const tiers = [
  ...
  },
  {
    ...
    build: "$14,997",
    monthly: "$2,497",
    description: "Everything. Every tool. Full optimization. For businesses that want the complete competitive edge.",
    features: [
      { name: "AI Voice Assistant (24/7)", included: true },
      { name: "Missed Call Text-Back", included: true },
      { name: "Appointment Reminders (24h + 2h)", included: true },
      ...
      { name: "Reputation Management Engine", included: true },
      { name: "No-Show Recovery", included: true },
      { name: "Dormant Customer Reactivation", included: true },
      { name: "Advanced Automations", included: true },
      { name: "Priority Support", included: true },
      { name: "Monthly Optimization Reports", included: true },
    ],
  },
];
