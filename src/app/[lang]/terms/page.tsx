...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const isEs = lang === "es";
  const title = isEs ? "Terminos y Condiciones" : "Terms & Conditions";
  const description = isEs
    ? "Terminos y condiciones de AI Peak Biz que rigen el uso de nuestro sitio web y servicios."
    : "AI Peak Biz terms and conditions governing use of our website and services.";
  const url = isEs
    ? "https://www.aipeakbiz.com/es/terms"
    : "https://www.aipeakbiz.com/terms";
