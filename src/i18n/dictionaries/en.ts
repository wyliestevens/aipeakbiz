const en = {
  ...
  missedLeads: {
    ...
    points: [
      ...
      },
      {
        ...
        description:
          "Leads come in during the workday. By the time you check voicemails at dinner, the customer already hired someone else.",
      },
      {
  ...
  howItWorks: {
    ...
    subheading: "Simple. No jargon. No complicated setup.",
    steps: [
      {
        title: "A lead comes in",
        description:
          "A customer fills out your website form, clicks a Google ad, or calls your business number.",
      },
      {
        title: "AI responds instantly",
        description:
          "Your AI assistant answers the call or texts back within seconds. It sounds natural, answers questions, and qualifies the lead.",
      },
      {
        title: "Appointment gets booked",
        description:
          "The qualified lead is booked directly on your calendar. You get a notification with all the details.",
      },
      {
  ...
  // Social Proof
  socialProof: {
    heading: "Trusted by real business owners",
    subheading:
  ...
  footer: {
    ...
    copyright: "2026 AI Peak Biz. All rights reserved.",
    bookCall: "Book a Strategy Call",
  },

  // Video Modal
  videoModal: {
    overview: "How AI Peak Biz Works",
    demo: "Real AI Call Demo",
